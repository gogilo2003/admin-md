...
@section('content')
    <div>
        <a href="{{ route('admin-roles-add') }}" class="btn btn-primary btn-sm"><span class="fa fa-plus"></span>&nbsp;&nbsp;
            New Role</a>
        <a href="{{ route('admin-users') }}" class="btn btn-primary btn-sm"><span class="fa fa-users"></span>&nbsp;&nbsp;
            Users</a>
    </div>
    <hr>
        ...
        <tbody>
            @foreach ($roles as $role)
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ route('admin-roles-edit', $role->id) }}" class="btn btn-success btn-sm"><span
                                    class="fa fa-edit"></span>&nbsp;&nbsp; Edit</a>
                            <a href="javascript:" data-id="{{ $role->id }}"
                                class="btn btn-danger btn-sm deleteRole"><span class="fas fa-trash-alt"></span>&nbsp;&nbsp;
                                Delete</a>
                        </div>
                    </td>
                </tr>
