...
@section('content')
    <form method="post" action="{{ route('admin-profiles-edit-post') }}" role="form" accept-charset="UTF-8"
            ...
            <div class="col-md-4 col-lg-4">
                <div class="form-group{!! $errors->has('picture') ? ' has-error' : '' !!}">
                    ...
                    <img id="picture_preview" class="picture_preview w-100 h100"
                        src="{{ $profile->picture ? asset(config('admin.path_prefix') . 'images/profiles/' . $profile->picture) : asset(config('admin.path_prefix') . 'vendor/admin/img/placeholder.png') }}"
                        alt="Preview">
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('name') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Enter name"
                                {!! old('name') ? ' value="' . old('name') . '"' : ' value="' . $profile->name . '"' !!}>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" id="pages" name="pages[]" data-live-search="true"
                                data-size="5" data-width="100%" data-tick-icon="fa fa-check-square-o" multiple
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('position') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control typeahead" id="position" name="position"
                                placeholder="Enter position" {!! old('position') ? ' value="' . old('position') . '"' : ' value="' . $profile->position . '"' !!} autocomplete="off"
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('facebook') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="facebook" name="facebook"
                                placeholder="Enter facebook" {!! old('facebook') ? ' value="' . old('facebook') . '"' : ' value="' . $profile->facebook . '"' !!}>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('twitter') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="twitter" name="twitter"
                                placeholder="Enter twitter" {!! old('twitter') ? ' value="' . old('twitter') . '"' : ' value="' . $profile->twitter . '"' !!}>
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('youtube') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="youtube" name="youtube"
                                placeholder="Enter Youtube" {!! old('youtube') ? ' value="' . old('youtube') . '"' : ' value="' . $profile->youtube . '"' !!}>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('linkedin') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="linkedin" name="linkedin"
                                placeholder="Enter Linkedin" {!! old('linkedin') ? ' value="' . old('linkedin') . '"' : ' value="' . $profile->linkedin . '"' !!}>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('dribble') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="dribble" name="dribble"
                                placeholder="Enter dribble" {!! old('dribble') ? ' value="' . old('dribble') . '"' : ' value="' . $profile->dribble . '"' !!}>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group{!! $errors->has('phone') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter phone no"
                                {!! old('phone') ? ' value="' . old('phone') . '"' : ' value="' . $profile->phone . '"' !!}>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group{!! $errors->has('email') ? ' has-error' : '' !!}">
                            ...
                            <input type="email" class="form-control" id="email" name="email" placeholder="Enter email"
                                {!! old('email') ? ' value="' . old('email') . '"' : ' value="' . $profile->email . '"' !!}>
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('box_no') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="box_no" name="box_no" placeholder="Enter box no"
                                {!! old('box_no') ? ' value="' . old('box_no') . '"' : ' value="' . $profile->box_no . '"' !!}>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('post_code') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="post_code" name="post_code"
                                placeholder="Enter post code" {!! old('post_code') ? ' value="' . old('post_code') . '"' : ' value="' . $profile->post_code . '"' !!}>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('town') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="town" name="town" placeholder="Enter town"
                                {!! old('town') ? ' value="' . old('town') . '"' : ' value="' . $profile->town . '"' !!}>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="form-group{!! $errors->has('address') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="address" name="address"
                                placeholder="Enter physical address" {!! old('address') ? ' value="' . old('address') . '"' : ' value="' . $profile->address . '"' !!}>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="form-group{!! $errors->has('details') ? ' has-error' : '' !!}">
                            ...
                            <textarea cols="5" class="form-control tinymce" id="details" name="details"
                                placeholder="Enter details">{!! old('details') ? old('details') : $profile->details !!}</textarea>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                complete: function(xhr) {
                    $('.typeahead').typeahead({
                        source: xhr.responseJSON
                    });
                }
            })

            var image = $('#picture_preview').cropper({
                aspectRatio: {{ config('admin.profile_picture.w') }} /
                    {{ config('admin.profile_picture.h') }},
                scalable: false,
            })
