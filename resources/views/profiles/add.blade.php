...
@section('content')
    <form method="post" action="{{ route('admin-profiles-add') }}" role="form" accept-charset="UTF-8"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('position') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control typeahead" id="position" name="position"
                                placeholder="Enter position" {!! old('position') ? ' value="' . old('position') . '"' : '' !!} autocomplete="off"
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('facebook') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="facebook" name="facebook"
                                placeholder="Enter facebook" {!! old('facebook') ? ' value="' . old('facebook') . '"' : '' !!}>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('twitter') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="twitter" name="twitter"
                                placeholder="Enter twitter" {!! old('twitter') ? ' value="' . old('twitter') . '"' : '' !!}>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('youtube') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="youtube" name="youtube"
                                placeholder="Enter Youtube" {!! old('youtube') ? ' value="' . old('youtube') . '"' : '' !!}>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('linkedin') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="linkedin" name="linkedin"
                                placeholder="Enter Linkedin" {!! old('linkedin') ? ' value="' . old('linkedin') . '"' : '' !!}>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('dribble') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="dribble" name="dribble"
                                placeholder="Enter dribble" {!! old('dribble') ? ' value="' . old('dribble') . '"' : '' !!}>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('phone') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone"
                                placeholder="Enter phone number" {!! old('phone') ? ' value="' . old('phone') . '"' : '' !!}>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group{!! $errors->has('post_code') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="post_code" name="post_code"
                                placeholder="Enter postCode" {!! old('post_code') ? ' value="' . old('post_code') . '"' : '' !!}>
                    ...
                    <div class="col-md-8 col-lg-8">
                        <div class="form-group{!! $errors->has('address') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control" id="address" name="address"
                                placeholder="Enter physical address" {!! old('address') ? ' value="' . old('address') . '"' : '' !!}>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="form-group{!! $errors->has('details') ? ' has-error' : '' !!}">
                            ...
                            <textarea rows="5" class="form-control tinymce" id="details" name="details"
                                placeholder="Enter details">{!! old('details') ? old('details') : '' !!}</textarea>
        ...
        <div class="text-center">
            ...
            <button type="submit" class="btn btn-lg btn-primary btn-round"><span class="fa fa-save"></span>
                Save</button>
        </div>
    </form>
@stop
