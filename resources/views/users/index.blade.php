...
@section('content')
    <div>
        <a href="{{ route('admin-users-add') }}" class="btn btn-primary btn-sm"><span class="fa fa-plus"></span>&nbsp;&nbsp;
            New User</a>
        <a href="{{ route('admin-roles') }}" class="btn btn-primary btn-sm"><span class="fa fa-list"></span>&nbsp;&nbsp;
            Roles</a>
    </div>
    <hr>
        ...
        <tbody>
            @foreach ($users as $user)
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ route('admin-users-edit', $user->id) }}" class="btn btn-success btn-sm"><span
                                    class="fa fa-edit"></span>&nbsp;&nbsp; Edit</a>
                            <a href="javascript:" data-id="{{ $user->id }}"
                                class="btn btn-warning btn-sm resetPassword"><span class="fas fa-sync"></span>&nbsp;&nbsp;
                                Reset Password</a>
                            <a href="javascript:" data-id="{{ $user->id }}"
                                class="btn btn-info btn-sm activateUser"><span class="fas fa-sync"></span>&nbsp;&nbsp;
                                Activate</a>
                            <a href="javascript:" data-id="{{ $user->id }}"
                                class="btn btn-danger btn-sm deleteUser"><span class="fas fa-trash-alt"></span>&nbsp;&nbsp;
                                Delete</a>
                        </div>
                    </td>
                </tr>
