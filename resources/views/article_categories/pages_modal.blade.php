<div class="modal fade" id="pagesModal" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="card" method="post" action="{{ route('admin-article_categories-pages') }}" role="form"
                ...
                <div class="card-body">
                    <select id="pages" name="pages[]" multiple class="selectpicker" data-size="5" data-width="100%"
