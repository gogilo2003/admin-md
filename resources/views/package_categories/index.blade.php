...
@section('breadcrumbs')
	@parent
	<li class="active"><span><i class="fa fa-folder-open-o"></i> Package Categories</span></li>
@stop
...
@section('content')
	<a href="{{ route('admin-package_categories-add') }}" class="btn btn-info btn-round"><i class="fa fa-plus"></i> Add Package Category</a>
	<hr>
	<div class="row">
	@foreach ($package_categories as $category)
		<div class="col-sm-6 col-md-4 col-lg-4">
			<div class="thumbnail text-center text-default">
				...
				@endif
				<p>
					<a href="{{route('admin-package_categories-edit',$category->id)}}" class="btn btn-primary btn-round"><span class="fa fa-edit"></span>&nbsp;&nbsp; Edit</a>
					<a data-id="{{ $category->id }}" data-pages="{{ json_encode($category->pageIds() )  }}" class="btn btn-info btn-round" data-toggle="modal" href='#pagesModal'><i class="fa fa-files-o"></i> Pages</a>
				</p>
			</div>
		</div>
	@endforeach
	...
	<div class="modal fade" id="pagesModal" data-backdrop="static">
        <div  class="modal-dialog">
            <form method="post" action="{{route('admin-package_categories-pages')}}" role="form" accept-charset="UTF-8" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <select name="pages[]" id="pages" data-live-search="true" data-size="5" data-tick-icon="fa fa-check-square" multiple data-width="100%" data-style="btn btn-outline-primary btn-round">
                        ...
                        <div class="card-footer">
                            <button type="button" class="btn btn-danger btn-round" data-dismiss="modal"><i class="fa fa-times"></i> Cancel</button>
