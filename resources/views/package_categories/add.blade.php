...
@section('breadcrumbs')
	...
	<li class="active"><span><i class="fa fa-plus"></i> New Package Category</span></li>
@stop
...
@section('content')
	<form method="post" action="{{route('admin-package_categories-add')}}" role="form" accept-charset="UTF-8" enctype="multipart/form-data">
		<div class="row">
