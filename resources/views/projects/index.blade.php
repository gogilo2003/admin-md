...
@section('content')
    <div>
        <a href="{{ route('admin-projects-add') }}" class="btn btn-primary btn-sm"><span class="fa fa-plus"></span>&nbsp;&nbsp;
            New Project</a>
        ...
        <tbody>
            @foreach ($projects as $project)
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ route('admin-projects-edit', $project->id) }}" class="btn btn-primary btn-sm"><span
                                    class="fa fa-edit"></span>&nbsp;&nbsp; Edit</a>
                            <a href="javascript:" data-id="{{ $project->id }}"
                                class="btn btn-primary btn-sm publishProject"><span
                                    class="fa fa-arrow-{{ $project->published ? 'down' : 'up' }}"></span>&nbsp;&nbsp;
                                {{ $project->published ? 'Un-Publish' : 'Publish' }}</a>
                            <a href="javascript:" data-id="{{ $project->id }}"
                                class="btn btn-danger btn-sm deleteProject"><span
