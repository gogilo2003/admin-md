...
@section('breadcrumbs')
	...
	<li class="active"><span>New Project</span></li>
@stop
...
@section('content')
	<form method="post" action="{{route('admin-projects-add')}}" project="form" accept-charset="UTF-8" enctype="multipart/form-data">
		...
		<div class="row">
			...
			<div class="col-md-12 col-lg-12">
				<div class="form-group{!! $errors->has('content') ? ' has-error':'' !!}">
					...
					<textarea class="form-control tinymce" rows="10" id="content" name="content" placeholder="Enter content">{!! ((old('content')) ? old('content') : '') !!}</textarea>
				</div>
			</div>
		</div>
