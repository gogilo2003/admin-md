...
<li class="nav-item{{ is_current_path('admin-tags') ? ' active' : '' }}"><a href="{{ route('admin-tags') }}"
        class="nav-link"><i class="fas fa-tags"></i> Tags</a></li>

<li class="nav-item{{ is_current_path('admin-authors') ? ' active' : '' }}"><a href="{{ route('admin-authors') }}"
        class="nav-link"><i class="fas fa-users"></i> Authors</a></li>
