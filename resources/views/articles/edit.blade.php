		...
		<div class="row">
			<div class="col-md-5 col-lg-3">
				...
				<div class="form-group{!! $errors->has('picture') ? ' has-error':'' !!}">
                    ...
                    <img id="picture_preview" class="picture_preview" src="{{ url($article->picture ? 'public/images/articles/'.$article->picture : 'public/vendor/admin/img/placeholder.png') }}" alt="Preview">
