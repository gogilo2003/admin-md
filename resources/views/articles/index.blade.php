...
@section('breadcrumbs')
    ...
    <li class="active"><span><i class="fas fa-copy"></i> Articles</span></li>
@endsection
...
@section('content')
    <div>
        <a href="{{ route('admin-articles-add') }}" class="btn btn-primary btn-sm"><span class="fa fa-plus"></span>&nbsp;&nbsp;
            New Article</a>
        ...
        <tbody>
            @foreach ($articles as $article)
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ route('admin-articles-edit', $article->id) }}" class="btn btn-primary btn-sm"><span
                                    class="fa fa-edit"></span>&nbsp;&nbsp; Edit</a>
                            <a href="javascript:" data-id="{{ $article->id }}"
                                class="btn btn-primary btn-sm publishArticle"><span
                                    class="fa fa-arrow-{{ $article->published ? 'down' : 'up' }}"></span>&nbsp;&nbsp;
                                {{ $article->published ? 'Un-publish' : 'Publish' }}</a>
                            <a href="javascript:" data-id="{{ $article->id }}"
