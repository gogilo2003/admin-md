...
@section('content')
    <form method="post" action="{{ route('admin-pages-add') }}" page="form" accept-charset="UTF-8"
                ...
                <div class="form-group{!! $errors->has('name') ? ' has-error' : '' !!}">
                    ...
                    <div>
                        <img id="image_preview" class="image_preview"
                            src="{{ asset(config('admin.path_prefix') . 'vendor/admin/img/placeholder.png') }}"
                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-6 col-md-8 col-lg-8 form-group{!! $errors->has('name') ? ' has-error' : '' !!}">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                            placeholder="Enter name"{!! old('name') ? ' value="' . old('name') . '"' : '' !!}>
                    ...
                    <div class="col-md-12 form-group{!! $errors->has('title') ? ' has-error' : '' !!}">
                        ...
                        <input type="text" class="form-control" id="title" name="title"
                            placeholder="Enter value"{!! old('title') ? ' value="' . old('title') . '"' : '' !!}>
