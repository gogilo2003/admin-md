...
@section('breadcrumbs')
    @parent
    <li class="active"><span><i class="fas fa-copy"></i> Pages</span></li>
@endsection
...
@section('content')
    <div>
        <a href="{{ route('admin-pages-add') }}" class="btn btn-primary btn-sm"><span class="fa fa-plus"></span>&nbsp;&nbsp;
            New Page</a>
        <a href="{{ route('admin-links') }}" class="btn btn-primary btn-sm"><span class="fa fa-link"></span>&nbsp;&nbsp;
            Links</a>
    </div>
    <hr>
        ...
        <tbody>
            @foreach ($pages as $page)
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ route('admin-pages-edit', $page->id) }}" class="btn btn-success btn-sm"><span
                                    class="fa fa-edit"></span>&nbsp;&nbsp; Edit</a>
                            <a href="javascript:" data-id="{{ $page->id }}"
                                class="btn btn-danger btn-sm deletePage"><span class="fas fa-trash-alt"></span>&nbsp;&nbsp;
                                Delete</a>
                        </div>
                    </td>
                </tr>
