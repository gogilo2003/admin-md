...
@section('content')
    <div>
        <a href="{{ route('admin-menus-add') }}" class="btn btn-primary btn-sm"><span class="fa fa-plus"></span>&nbsp;&nbsp;
            New Menu</a>
        ...
        <tbody>
            @foreach ($menus as $menu)
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ route('admin-menus-edit', $menu->id) }}" class="btn btn-success btn-sm"><span
                                    class="fa fa-edit"></span>&nbsp;&nbsp; Edit</a>
                            <a href="javascript:" data-id="{{ $menu->id }}"
                                class="btn btn-danger btn-sm deleteMenu"><span class="fas fa-trash-alt"></span>&nbsp;&nbsp;
                                Delete</a>
                        </div>
                    </td>
                </tr>
