...
@section('title')
	New Picture Category
@endsection

@section('page_title')
	<i class="fa fa-plus-circle"></i> New Picture Category
@endsection
...
@section('breadcrumbs')
	...
	<li class="active"><span><i class="fa fa-plus-circle"></i> New Category</span></li>
@endsection
...
@section('content')
	<form method="post" action="{{route('admin-picture_categories-add')}}" role="form" accept-charset="UTF-8" enctype="multipart/form-data">
		...
		<div class="row">
			...
			<div class="col-md-4 col-lg-4">
				<div class="form-group{!! $errors->has('file_extensions') ? ' has-error':'' !!}">
					...
					<input type="text" class="form-control" id="file_extensions" name="file_extensions" placeholder="Enter file extensions"{!! ((old('file_extensions')) ? ' value="'.old('file_extensions').'"' : ' value="jpeg,jpg,gif,png,bmp"') !!}>
			...
			<div class="col-md-4 col-lg-4">
				<div class="form-group{!! $errors->has('max_file_size') ? ' has-error':'' !!}">
					...
					<input type="text" class="form-control" id="max_file_size" name="max_file_size" placeholder="Enter max file size"{!! ((old('max_file_size')) ? ' value="'.old('max_file_size').'"' : ' value="50"') !!}>
			...
			<div class="col-md-4 col-lg-4">
				<div class="form-group{!! $errors->has('min_height') ? ' has-error':'' !!}">
					...
					<input type="text" class="form-control" id="min_height" name="min_height" placeholder="Enter min height"{!! ((old('min_height')) ? ' value="'.old('min_height').'"' : ' value="240"') !!}>
			...
			<div class="col-md-4 col-lg-4">
				<div class="form-group{!! $errors->has('min_width') ? ' has-error':'' !!}">
					...
					<input type="text" class="form-control" id="min_width" name="min_width" placeholder="Enter min width"{!! ((old('min_width')) ? ' value="'.old('min_width').'"' : ' value="320"') !!}>
			...
			<div class="col-md-4 col-lg-4">
				<div class="form-group{!! $errors->has('max_height') ? ' has-error':'' !!}">
					...
					<input type="text" class="form-control" id="max_height" name="max_height" placeholder="Enter max height"{!! ((old('max_height')) ? ' value="'.old('max_height').'"' : ' value="960"') !!}>
			...
			<div class="col-md-4 col-lg-4">
				<div class="form-group{!! $errors->has('max_width') ? ' has-error':'' !!}">
					...
					<input type="text" class="form-control" id="max_width" name="max_width" placeholder="Enter max width"{!! ((old('max_width')) ? ' value="'.old('max_width').'"' : ' value="1280"') !!}>
