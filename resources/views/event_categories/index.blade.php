...
@section('content')
	<a href="{{ route('admin-event_categories-add') }}" class="btn btn-info btn-round"><i class="fa fa-plus"></i> Add Event Category</a>
	<hr>
	<div class="row">
	@foreach ($event_categories as $category)
		<div class="col-sm-6 col-md-4 col-lg-4">
			<div class="thumbnail text-center text-default">
				...
				@endif
				<p>
					<a href="{{route('admin-event_categories-edit',$category->id)}}" class="btn btn-primary btn-round"><span class="fa fa-edit"></span>&nbsp;&nbsp; Edit</a>
	...
	<div class="modal fade" id="pagesModal" data-backdrop="static">
        <div  class="modal-dialog">
            <form method="post" action="{{route('admin-event_categories-pages')}}" role="form" accept-charset="UTF-8" enctype="multipart/form-data">
