...
@section('content')
    <a href="{{ route('admin-event_categories-add') }}" class="btn btn-info btn-round"><i class="fa fa-plus"></i> Add Event
        Category</a>
    <hr>
    <div class="row">
                ...
                <div class="thumbnail text-center text-default">
                    ...
                    <p>
                        <a href="{{ route('admin-event_categories-edit', $category->id) }}"
                            class="btn btn-primary btn-round"><span class="fa fa-edit"></span>&nbsp;&nbsp; Edit</a>
                        <a data-id="{{ $category->id }}" data-pages="{{ json_encode($category->pageIds()) }}"
                            class="btn btn-info btn-round" data-toggle="modal" href='#pagesModal'><i
    ...
    <div class="modal fade" id="pagesModal" data-backdrop="static">
        <div class="modal-dialog">
            <form method="post" action="{{ route('admin-event_categories-pages') }}" role="form" accept-charset="UTF-8"
                ...
                <div class="modal-content">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <button type="button" class="close btn btn-danger btn-sm btn-fab btn-round"
                                data-dismiss="modal" aria-hidden="true"><span class="material-icons">close</span></button>
                            <h4 class="card-title">Select Pages</h4>
                        </div>
                        <div class="card-body">
                            <select name="pages[]" id="pages" data-live-search="true" data-size="5"
                                data-tick-icon="fa fa-check-square" multiple data-width="100%"
                                data-style="btn btn-outline-primary btn-round">
